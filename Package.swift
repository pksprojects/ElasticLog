...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "ElasticNIOClient",
            targets: ["ElasticNIOClient"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "ElasticLog",
            dependencies: ["Logging", "NIO", "NIOConcurrencyHelpers", "NIOSSL", "ElasticNIOClient"]
        ),
        .target(
            name: "ElasticNIOClient",
            dependencies: ["NIO", "NIOConcurrencyHelpers", "NIOSSL"]
        ),
        .testTarget(
